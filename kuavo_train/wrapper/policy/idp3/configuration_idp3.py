...
@dataclass
class IDP3Config(PreTrainedConfig):
    ...
    drop_n_last_frames: int = 0  # 7  # horizon - n_action_steps - n_obs_steps + 1
    ...
    # Inference
    num_inference_steps: int = 10  # | None = None
    ...
    def __post_init__(self):
        ...
        self.obs_dict = {
            "observation.pointcloud": [self.pointcloud_encoder_cfg.num_points, 3],
